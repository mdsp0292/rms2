    ...
    <div className="flex items-center justify-between w-full p-4 text-sm bg-white border-b md:py-0 md:px-12 d:text-md">
      ...
      <div className="flex ml-auto">
        ...
        <div className={menuOpened ? '' : 'hidden'}>
          <div className="absolute top-5 right-3 left-auto z-20 py-2 mt-8 text-sm whitespace-nowrap bg-white rounded shadow-xl">
            <InertiaLink
              href={route('users.edit', auth.user.id)}
              className="block px-6 py-2 hover:bg-mirage-400 hover:text-white"
            ...
            <InertiaLink
              as="button"
              href={route('logout')}
              className="block w-full px-6 py-2 text-left focus:outline-none hover:bg-mirage-400 hover:text-white"
              method="post"
            >
              Logout
            </InertiaLink>
